...
const orbitSizes = [
  "h-[250px] w-[250px] md:h-[286px] md:w-[286px]",
  "h-[350px] w-[350px] md:h-[394px] md:w-[394px]",
  "h-[458px] w-[458px] md:h-[508px] md:w-[508px]",
  "h-[560px] w-[560px] md:h-[622px] md:w-[622px]",
];
...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-black text-[#cad1e9]">
      <div className="pointer-events-none absolute inset-y-0 left-0 w-30 bg-[radial-gradient(circle_at_left,rgba(77,45,151,0.32),transparent_72%)]" />
      <div className="pointer-events-none absolute inset-y-0 right-0 w-30 bg-[radial-gradient(circle_at_right,rgba(77,45,151,0.32),transparent_72%)]" />
      ...
      <div className="relative mx-auto max-w-280 px-4 pb-22 pt-2.5 md:px-6">
        <header className="mx-auto flex max-w-244.5 items-center justify-between rounded-lg border border-white/8 bg-[#120d1c]/90 px-2.5 py-1.75 shadow-[inset_0_0_0_1px_rgba(255,255,255,0.02)] backdrop-blur-[14px]">
          <div className="flex items-center gap-1.75">
            <Image
              src="/logo.svg"
              ...
              height={15}
            />
            <span className="font-mono text-[11px] font-bold tracking-[-0.16px] text-[#cad1e9] md:text-[12px]">
              IdentityHub
            </span>
          </div>

          <nav className="hidden items-center gap-5.5 text-[9px] text-[#bfb8cf] lg:flex">
            {navItems.map((item) => (
              <a
                key={item}
          ...
          <button className="rounded-[7px] border border-[#2a2541] bg-[#171125] px-2.5 py-1.25 text-[9px] font-medium text-[#d2cde3] shadow-[inset_0_0_0_1px_rgba(255,255,255,0.03)] transition hover:border-[#5b4aff]">
            Start free trial
            <span className="ml-1.5 text-[10px] text-[#7a73a1]">›</span>
          </button>
        </header>

        <div className="relative mx-auto max-w-245 pt-6.5 text-center md:pt-8.5">
          <div className="absolute left-1/2 top-15 h-18 w-18 -translate-x-1/2 rounded-full bg-[radial-gradient(circle,rgba(194,124,255,0.22),rgba(194,124,255,0)_70%)] blur-[14px]" />

          <div className="relative z-20 mx-auto inline-flex rounded-[22px] border border-[#b287ff]/65 bg-[linear-gradient(180deg,rgba(180,126,255,0.5),rgba(107,58,209,0.24))] px-3.75 py-1.75 shadow-[0_8px_24px_rgba(189,112,255,0.28),inset_0_0_10px_rgba(255,255,255,0.16)] backdrop-blur-[10px]">
            <span className="text-[8px] font-medium leading-none text-white">
              Secure your data
            </span>
          </div>

          <h1 className="relative z-20 mx-auto mt-3.5 max-w-176.25 font-sora text-[34px] font-semibold leading-[0.94] tracking-[-0.04em] text-transparent md:text-[40px] lg:text-[58px]">
          ...
          <div className="relative z-20 mx-auto mt-1.5 h-2.5 w-46.5 md:w-56">
          ...
          <p className="relative z-20 mx-auto mt-2.5 max-w-127.5 text-[10px] leading-[1.55] text-[#d8d1ea] md:text-[11px] lg:text-[12px]">
          ...
          <div className="relative z-20 mt-3 flex items-center justify-center gap-2">
            <button className="rounded-[7px] border border-[#2b2440] bg-[#20172d] px-2.75 py-1.5 text-[8px] font-medium text-white shadow-[inset_0_0_10px_rgba(255,255,255,0.07)]">
              Start free trial
            </button>
            <button className="rounded-[7px] border border-[#d754f6]/40 bg-[linear-gradient(90deg,#5c57ff,#da43f2)] px-2.75 py-1.5 text-[8px] font-medium text-white shadow-[0_8px_24px_rgba(117,78,255,0.28)]">
              Use It Now
            </button>
          </div>

          <div className="relative mx-auto mt-4.5 h-105 w-full max-w-192.5 md:h-122">
            <div className="pointer-events-none absolute left-1/2 top-[53%] h-40 w-40 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(circle,rgba(78,92,255,0.22),rgba(218,67,242,0.14)_42%,rgba(0,0,0,0)_70%)] blur-[20px]" />
            ...
            <div className="absolute left-1/2 top-[53%] z-20 w-49 -translate-x-1/2 -translate-y-1/2 md:w-61">
              <Image
                src="/hero.png"
