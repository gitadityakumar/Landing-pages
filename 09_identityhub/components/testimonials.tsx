function ArrowButton({ direction }: { direction: "left" | "right" }) {
  return (
    <button
      ...
      className="flex h-9 w-9 items-center justify-center rounded-full border border-[#8e3dff] bg-[linear-gradient(180deg,#8a44ff_0%,#5d2df5_100%)] text-white shadow-[0_14px_30px_rgba(123,70,255,0.32)] transition hover:brightness-110"
    >
    ...
    <section id="testimonials" className="py-16 md:py-20">
      <div className="mx-auto max-w-310">
        <div className="text-center">
          ...
          <h2 className="mt-6 font-sora text-[34px] font-semibold leading-[1.02] tracking-[-0.05em] text-[#dcd9eb] md:text-[46px]">
            What’s our user{" "}
        ...
        <div className="relative mx-auto mt-9 max-w-260 px-6 md:px-10">
          ...
          <div className="rounded-3xl border border-white/6 bg-[radial-gradient(circle_at_70%_35%,rgba(59,53,108,0.16),rgba(16,13,28,0.98)_58%,rgba(10,8,16,1)_100%)] px-7 py-7 shadow-[inset_0_0_0_1px_rgba(255,255,255,0.012)]">
            <div className="rounded-[22px] border border-white/5 bg-[linear-gradient(180deg,rgba(255,255,255,0.05),rgba(255,255,255,0.02))] px-6 py-6 shadow-[inset_0_0_0_1px_rgba(255,255,255,0.01)] md:px-8 md:py-7">
              <div className="flex items-start gap-4">
                ...
                <div className="min-w-0">
                  <h3 className="font-sora text-[20px] font-semibold leading-none text-white md:text-[22px]">
                    David J. Karem
                  </h3>
                  <p className="mt-2 text-[15px] leading-none text-[#a9a3b8]">
                    Businessmen • 1 day ago
                  </p>
                </div>
              </div>

              <p className="mt-6 max-w-220 text-[16px] leading-[1.42] text-[#c7c1d6] md:text-[18px]">
